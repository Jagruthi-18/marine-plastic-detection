...
import tf_keras as keras
from tf_keras.applications import MobileNetV2
from tf_keras.layers import GlobalAveragePooling2D, Dense, InputLayer
from tf_keras.models import Sequential
import tf_keras.saving

# ✅ Patch to fix 'batch_shape' and 'optional' conflict
...
# ✅ Override the InputLayer in keras
tf_keras.layers.InputLayer = PatchedInputLayer
